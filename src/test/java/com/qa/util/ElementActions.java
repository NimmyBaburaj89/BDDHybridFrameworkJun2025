...
public class ElementActions {
	 ...
	 * @param elem
	 * @param scenario
	 * @return This method will wait for fluent wait time and when element is visible get the text and return the string value
	 */
	 ...
	 * @param elem
	 * @param scenario
	 * This method will take element as parameter and wait for explicit wait time and then perform click operation
	 */
